...
void ppts_width_align_right_i_d(char* num_s, char* str, int col_spaces, int col_zeros, struct info *mys);
void ppts_width_align_left_i_d(char *num_s, char *str, int col_spaces, int col_zeros);
